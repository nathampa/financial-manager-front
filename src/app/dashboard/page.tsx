...
export default function DashboardPage() {
  ...
  const loadDashboardData = async () => {
    try {
      ...
      setCategoryData(
        (categoryResponse.data || []).map((item: CategoryChartData) => ({
          ...item,
  ...
  return (
    <div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-6">
                ...
                >
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-500">{account.type_display}</p>
                    </div>
                  </div>
                  <p
        ...
        <div className="bg-white rounded-xl shadow-lg p-6">
          <h2 className="text-xl font-bold text-gray-800 mb-6">Despesas por Categoria</h2>
          {categoryData.length === 0 ? (
            ...
            <div className="h-64">
              <ResponsiveContainer width="100%" height="100%">
                <PieChart>
                  <Pie data={categoryData} dataKey="total" nameKey="category__name" outerRadius={90}>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="bg-white rounded-xl shadow-lg p-6">
          <h2 className="text-xl font-bold text-gray-800 mb-6">Maiores Despesas</h2>
                ...
                <div key={index}>
                  <div className="flex items-center justify-between mb-2">
                    <div className="flex items-center gap-2">
                      ...
                      <span className="text-gray-700 font-medium">{expense.category__name}</span>
                    </div>
                    <span className="text-gray-800 font-bold">{formatCurrency(expense.total)}</span>
                  </div>
                  <div className="text-xs text-gray-500 mb-2">{expense.count} transações</div>
                </div>
              ))}
            </div>
          )}
