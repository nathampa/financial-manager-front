                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-500">
                      {transaction.category_detail?.name || transaction.category_name || 'Categoria'} •{' '}
                      {formatDate(transaction.date)}
                    </p>
                    {transaction.status_display && (
                      <span className="text-xs text-gray-500">{transaction.status_display}</span>
                    )}
                  </div>
                </div>
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-white rounded-xl p-8 max-w-md w-full mx-4 max-h-[90vh] overflow-y-auto">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div>
                <label className="block text-sm font-semibold text-gray-900 mb-2">Notas</label>
                <textarea
              ...
              <div>
                <label className="block text-sm font-semibold text-gray-900 mb-2">URL do recibo</label>
                <input
                  type="url"
